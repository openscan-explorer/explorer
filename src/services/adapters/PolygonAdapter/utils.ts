 ...
 */
export function transformPolygonBlockToBlock(rpcBlock: PolygonBlock): Block {
 ...
 */
export function transformPolygonTransactionToTransaction(
  rpcTx: PolygonTransaction,
  receipt?: PolygonTransactionReceipt | null,
): Transaction {
