...
export function useENS(
	...
	const [reverseResult, setReverseResult] = useState<ENSReverseResult | null>(
		null,
	);
	const [records, setRecords] = useState<ENSRecords | null>(null);
	const [decodedContenthash, setDecodedContenthash] =
		useState<DecodedContenthash | null>(null);
