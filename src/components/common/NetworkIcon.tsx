...
// Ethereum SVG icon
const EthereumIcon: React.FC<{ color: string; size: number }> = ({
	color,
	size,
}) => (
	<svg
...
// Polygon SVG icon
const PolygonIcon: React.FC<{ color: string; size: number }> = ({
	color,
	size,
}) => (
	<svg
...
export const NetworkIcon: React.FC<NetworkIconProps> = ({
	...
	switch (network.logoType) {
		...
		case "bsc":
			return (
				<BscIcon
					color={network.color}
					size={size}
					opacity={network.isTestnet ? 0.7 : 1}
				/>
			);
		case "polygon":
		...
		case "arbitrum":
			return (
				<img src={arbitrumLogo} alt="Arbitrum" width={size} height={size} />
			);
		case "optimism":
			return (
				<img src={optimismLogo} alt="Optimism" width={size} height={size} />
			);
		case "base":
			return <img src={baseLogo} alt="Base" width={size} height={size} />;
		case "hardhat":
			return (
				<img src={hardhatLogo} alt="Localhost" width={size} height={size} />
			);
		default:
			return <EthereumIcon color={network.color} size={size} />;
	}
