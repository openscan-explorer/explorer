...
describe("DevTools Utils", () => {
  ...
  const SIMPLE_SIGNATURE =
    "0xf4a45954390e10d2db95527ecfaca14adfd74127e5a885fcaaaed2a1b5bd73254f82e26a591778e44c23bda32a0bc89a8a066e3884b27f4f449ac1f51eb2f9d81c";
  ...
  const RAW_HASH_SIGNATURE =
    "0x5d8bd006953f0e4e24843f6d70ac7100dfc272afbb7c6baedbcd8beeb7fdb94902d539f30fcb46a1ec63c6fdb8f9f51a9af1c2a01f8aaa1ed9f1a5c32f7b54fc1c";

  // Test case 3: EIP-191 arbitrary data (0x45 version)
  const EIP191_MESSAGE = "0x457468657265756d2d4c32";
  const EIP191_SIGNATURE =
    "0x80c65f13df0840455fe9194c7a8d17dfb2d9696dbb669f53b06ba7f3a8888f0b51612b97d37b5226f0a4dc7dcfe5e8ce7f6618c0a5b75e56200de6f0d773f98c1b";
  ...
  const EIP712_SIGNATURE =
    "0x2d480fdcd216ca933662705a13a539a8f979b29d69ee83a92389db8dd9e7f36a0f1dca546b14b8af72cbb02ca81237e9474413f6506c792da060e9981373bd051c";

  // Test case 5: EIP-191 Personal Sign with UTF-8 emoji
  const EMOJI_MESSAGE = "🔥 Test message for Augusto 🔥";
  const EMOJI_SIGNATURE =
    "0x06f6fd97a02e3b4811a53f17ef449f7d0be7ed96775847c63742aede1ac6b97875512c66af08b8e8dfa38f9a0eed3c28ba632a2c00c2522dbf316efee375d3161b";
  ...
  describe("addressesMatch", () => {
    ...
    it("should not match different addresses", () => {
      expect(addressesMatch(TEST_ADDRESS, "0x1234567890123456789012345678901234567890")).toBe(
        false,
      );
    });
  ...
  const MALLEATED_SIGNATURE =
    "0xf4a45954390e10d2db95527ecfaca14adfd74127e5a885fcaaaed2a1b5bd7325b07d1d9596e8871bb3dc4253d5f43675859f1f9097ad80b13b6538f13814d9621c";

  // 2) Invalid recovery id (v = 0x35, should be 27, 28, 0, or 1)
  const BAD_V_SIGNATURE =
    "0xf4a45954390e10d2db95527ecfaca14adfd74127e5a885fcaaaed2a1b5bd73254f82e26a591778e44c23bda32a0bc89a8a066e3884b27f4f449ac1f51eb2f9d835";

  // 3) Signature that recovers to wrong address
  const WRONG_SIGNER_SIGNATURE =
  ...
  const MISSING_V_SIGNATURE =
    "0xf4a45954390e10d2db95527ecfaca14adfd74127e5a885fcaaaed2a1b5bd73254f82e26a591778e44c23bda32a0bc89a8a066e3884b27f4f449ac1f51eb2f9d8"; // only 64 bytes (r + s)
  const INVALID_HEX_SIGNATURE =
    "0xf4a45954390e10d2db95527ecfaca14adfd74127e5a885fcaaaed2a1b5bd7325ZZ82e26a591778e44c23bda32a0bc89a8a066e3884b27f4f449ac1f51eb2f9d81c";
  const EXTRA_BYTES_SIGNATURE =
    "0xf4a45954390e10d2db95527ecfaca14adfd74127e5a885fcaaaed2a1b5bd73254f82e26a591778e44c23bda32a0bc89a8a066e3884b27f4f449ac1f51eb2f9d81cdeadbeef";
