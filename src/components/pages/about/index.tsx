      ...
      <div className="page-card">
        ...
        <div className="text-center mb-large opensource-card">
          ...
          <p className="opensource-description">
            OpenScan is free and open source software. Contributions, issues, and feature requests
            are welcome!
          </p>
          <a
        ...
        <div className="text-center license-footer">
          ...
          <p className="license-footer-spacing">Built with ❤️ for the Ethereum community</p>
        </div>
      </div>
    </div>
  );
